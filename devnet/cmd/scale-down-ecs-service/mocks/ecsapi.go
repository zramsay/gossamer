...
// NewECSAPI creates a new instance of ECSAPI. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewECSAPI(t testing.TB) *ECSAPI {
	mock := &ECSAPI{}
	mock.Mock.Test(t)
