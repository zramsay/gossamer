...
// NewVersion creates a new instance of Version. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewVersion(t testing.TB) *Version {
	mock := &Version{}
	mock.Mock.Test(t)
