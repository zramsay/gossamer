...
// NewTransactionState creates a new instance of TransactionState. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewTransactionState(t testing.TB) *TransactionState {
