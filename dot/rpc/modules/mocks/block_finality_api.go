...
// NewBlockFinalityAPI creates a new instance of BlockFinalityAPI. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewBlockFinalityAPI(t testing.TB) *BlockFinalityAPI {
