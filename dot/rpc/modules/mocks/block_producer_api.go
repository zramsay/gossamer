...
// NewBlockProducerAPI creates a new instance of BlockProducerAPI. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewBlockProducerAPI(t testing.TB) *BlockProducerAPI {
	mock := &BlockProducerAPI{}
	mock.Mock.Test(t)
