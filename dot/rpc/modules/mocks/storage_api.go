...
// NewStorageAPI creates a new instance of StorageAPI. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewStorageAPI(t testing.TB) *StorageAPI {
	mock := &StorageAPI{}
	mock.Mock.Test(t)
