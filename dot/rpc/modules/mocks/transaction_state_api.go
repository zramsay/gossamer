...
// NewTransactionStateAPI creates a new instance of TransactionStateAPI. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewTransactionStateAPI(t testing.TB) *TransactionStateAPI {
