...
// NewRuntimeStorageAPI creates a new instance of RuntimeStorageAPI. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewRuntimeStorageAPI(t testing.TB) *RuntimeStorageAPI {
