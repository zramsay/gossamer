...
// NewCoreAPI creates a new instance of CoreAPI. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewCoreAPI(t testing.TB) *CoreAPI {
	mock := &CoreAPI{}
	mock.Mock.Test(t)
