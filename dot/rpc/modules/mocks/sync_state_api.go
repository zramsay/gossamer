...
// NewSyncStateAPI creates a new instance of SyncStateAPI. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewSyncStateAPI(t testing.TB) *SyncStateAPI {
	mock := &SyncStateAPI{}
	mock.Mock.Test(t)
