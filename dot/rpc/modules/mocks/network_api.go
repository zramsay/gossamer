...
// NewNetworkAPI creates a new instance of NetworkAPI. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewNetworkAPI(t testing.TB) *NetworkAPI {
	mock := &NetworkAPI{}
	mock.Mock.Test(t)
