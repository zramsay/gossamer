...
// NewBlockAPI creates a new instance of BlockAPI. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewBlockAPI(t testing.TB) *BlockAPI {
	mock := &BlockAPI{}
	mock.Mock.Test(t)
