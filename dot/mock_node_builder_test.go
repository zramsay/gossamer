...
func (m *MocknodeBuilderIface) createBABEService(cfg *Config, st state.Service, ks keystore.Keystore, cs *core.Service, telemetryMailer telemetry.Client) (*babe.Service, error) {
	m.ctrl.T.Helper()
