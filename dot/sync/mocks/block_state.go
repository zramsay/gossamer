...
// NewBlockState creates a new instance of BlockState. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewBlockState(t testing.TB) *BlockState {
	mock := &BlockState{}
	mock.Mock.Test(t)
